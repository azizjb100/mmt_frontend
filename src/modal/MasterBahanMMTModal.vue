  ...
  >
    <v-card class="dialog-card d-flex flex-column" style="height: 80vh;">
      <v-toolbar color="primary" density="compact">
        <v-toolbar-title class="text-subtitle-1 font-weight-bold">🔍 Pencarian Master Bahan MMT (WH-16)</v-toolbar-title>
        <v-spacer></v-spacer>
...
// --- State ---
const API_URL = 'http://localhost:8000/api/master/bahan/mmt'; 
