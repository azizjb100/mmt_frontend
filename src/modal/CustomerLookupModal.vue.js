...
const headers = [
    ...
    { title: 'Aksi', key: 'actions', sortable: false, width: '80px', align: 'center' },
];
// --- API & Logic ---
const fetchCustomers = async () => {
    ...
    try {
        ...
        const response = await api.get('mmt/customer/lookup');
...
const filteredCustomers = computed(() => {
    ...
    return customers.value.filter(c => c.Kode.toLowerCase().includes(query) ||
...
const __VLS_53 = ({ keyup: {} },
    { onKeyup: (__VLS_ctx.fetchCustomers) });
// @ts-ignore
...
const __VLS_56 = __VLS_asFunctionalComponent(__VLS_55, new __VLS_55({
    ...
    items: (__VLS_ctx.filteredCustomers),
...
// @ts-ignore
[headers, filteredCustomers, isLoading,];
{
