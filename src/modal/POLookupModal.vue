    ...
    >
        <v-card class="dialog-card d-flex flex-column" style="height: 80vh;">
            <v-toolbar color="primary" density="compact">
                <v-toolbar-title class="text-subtitle-1 font-weight-bold">Bantuan - Pilih Purchase Order (PO)</v-toolbar-title>
                <v-spacer></v-spacer>
...
// --- State ---
const API_URL = 'http://localhost:8000/api/mmt/penerimaan-bahan/po/lookup'; 
...
toast.error((err.response?.data as any)?.message || 'Gagal mengambil daftar PO.');
        poList.value = [];
    } finally {
        loading.value = false;
    }
