...
const fetchPrintData = async (nomor: string) => {
  ...
  try {
    const response = await api.get(`mmt/pengajuan-permintaan/print/${nomor}`);
  ...
  <div class="pp-print-container">
    ...
    <div v-else-if="printData" class="pp-page">
      ...
      <div class="header-info">
        <div class="left-column">
          ...
          <div class="info-row">
            ...
            <span class="value">: {{ printData.JenisPengajuan }}</span>
          </div>
        </div>
      ...
      <div class="print-note">
        * Dokumen ini merupakan bukti pengajuan persiapan pengadaan barang.
      </div>
    </div>
  </div>
</template>
