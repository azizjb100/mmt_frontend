                                ...
                                <div class="detail-wrapper pa-4">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="font-weight-bold text-blue-darken-2"
                                                >
                                                    {{
                                                        Number(
                                                            value || 0,
...
const fetchMasterData = async () => {
    ...
    try {
        const payload = {
            ...
            mesin:
                filters.mesin.length > 0 ? filters.mesin.join(",") : undefined,
        };
