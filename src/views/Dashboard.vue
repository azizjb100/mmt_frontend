...
<div class="dashboard-layout-top font-body">
 ...
 <div class="navbar-user">
  <span class="user-welcome">Selamat datang, <b class="font-semibold">{{ currentUser?.nmUser || 'UserAdmin' }}</b></span>
  <button @click="handleLogout" class="logout-button rounded-soft transition-smooth hover-lift">Logout</button>
 </div>
 </nav>
...
const handleLogout = () => {
// Asumsi fungsi logout() didefinisikan atau diimpor di tempat lain
// logout(); 
router.push('/login');
};
