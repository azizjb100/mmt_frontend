...
.main-container {
  display: flex;
  width: 1000px; /* Ukuran disesuaikan agar proporsional */
  height: 500px;
  border-radius: 12px;
  overflow: hidden;
  box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4);
  background: #ffffff; /* Dasar putih untuk sisi ilustrasi */
}
...
.overlay-text h1 {
  font-size: 3rem;
  color: #334155; /* Warna teks gelap sesuai gambar */
  margin: 0;
  font-weight: 800;
  letter-spacing: -1px;
}
...
.error-message { color: #fb7185; font-size: 0.8rem; margin-top: 15px; text-align: center; }
.success-message { color: #34d399; font-size: 0.8rem; margin-top: 15px; text-align: center; }
</style>